...
public class ActionReplay : MonoBehaviour
{
    ...
    [SerializeField]
    private bool flag = true;//リプレイモードにする為の判定を1回だけ行うためだけのフラグ
    private float ReplaySpeed = 3.0f;//リプレイの速さの変数
    private float currentReplayIndex;
    private Rigidbody rb;
    private List<ReplayRecorder> replayRecorders = new List<ReplayRecorder>();//動きを格納しているリスト
